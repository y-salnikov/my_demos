...
void (*opl_advance_callback)(void)=dummy;
...
void operator_off(op_type* dummy/*op_pt*/) {
}
...
void opl_set_advance_callback(void (*callback)(void))
{
	opl_advance_callback=callback;
}
